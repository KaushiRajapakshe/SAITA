...
network_categorizing_questions = ["Is the network signal available?",
                                  ...
                                  "Is the network listed in the computer?", "result"]  # Network issue categorizing questions

directory_categorizing_questions = ["Did system showed any issue indications?",
                                    "Is the related drive listed in the computer?",
                                    "Did you previously worked with this functionality?",
                                    "Did you notice any anomalies in the computer?", "result"]  # Directory issue categorizing questions
...
userconf_categorizing_questions = ["Do you have access permission for this function?",
                                   ...
                                   "Did you previously worked with this functionality?",
                                   "Did you notice any anomalies in the computer?", "result"]  # User configuration issue categorizing questions
...
userconf_identifying_questions = ["What is the Error message displayed on the screen?",
                                  ...
                                  "Please enter user account name", "result"]  # User configuration issue identification questions

network_identifying_questions = ["What is the Error message displayed on the screen?",
                                 "What is the Error code or number displayed on the screen?",
                                 "What is your connection type (Internet/Intranet)?", "result"]  # network issue identification questions
...
directory_identifying_questions = ["What is the Error message displayed on the screen?",
                                   ...
                                   "Please provide File/Directory/Drive path", "result"]  # Directory issue identification questions

Ranking_question="Please rate the previous solution on a rating scale of 1-5, where 1 is ‘Not Helpful’ and 5 is ‘Very Helpful':"  # Probable issue ranking question
