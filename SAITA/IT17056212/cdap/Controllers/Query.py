...
class Queries:
    ...
    # Get all network solution categorizing data
    @classmethod
    ...
    # Get technical solution ID by issue ID
    @classmethod
    ...
    # Get non-technical solution ID by issue ID
    @classmethod
    ...
    # Get keywords by non-technical solution ID
    @classmethod
    ...
    # Get permanent parameters by issue ID
    @classmethod
    ...
    # Get technical solution sequence by issue ID
    @classmethod
    ...
    # Get technical solution variables by cid
    @classmethod
    ...
    # Get technical solution PowerShell command by cid
    @classmethod
    ...
    # Get technical solution warning by solution id
    @classmethod
    ...
    # Get all directory solution categorizing data
    @classmethod
    ...
    # Get all user configuration error data
    @classmethod
    ...
    # Get all user configuration solution categorizing data
    @classmethod
