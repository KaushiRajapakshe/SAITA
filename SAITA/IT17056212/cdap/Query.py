...
class Queries:
    ...
    @classmethod
    def get_network_tech_solution_id_by_issue_id(cls, issue_id):
        return cls.mydb.select_param_query('SELECT tech_solution FROM network_issues where issue_id=%s', (issue_id,))

    @classmethod
    def get_network_nontech_solution_id_by_issue_id(cls, issue_id):
    ...
    def get_keywards_by_nontech_solution_id(cls, nontech_solution_id):
        return cls.mydb.select_param_query('SELECT nt_keywards FROM nontechnical_solutions where nt_id=%s', (nontech_solution_id,))
