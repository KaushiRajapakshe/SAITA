...
class GuiPopupWindow:
    ...
    def creat_download_body(self):
        ...
        self.filecount = Label(self.top_in_window_body, text=0, bg=message_body_color, font="bold")
        self.filecount.config(font=("arial", fontsize))
        self.filecount.pack(fill=X, pady=10)
